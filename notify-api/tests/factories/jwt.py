...
def helper_create_jwt(jwt_manager, roles: List[str] = [], username: str = 'test-user'):  # pylint: disable=dangerous-default-value
...
def create_header(jwt_manager, roles: List[str] = [], username: str = 'test-user', **kwargs):  # pylint: disable=dangerous-default-value
