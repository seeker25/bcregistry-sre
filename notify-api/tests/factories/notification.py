...
class NotificationFactory():  # pylint: disable=too-few-public-methods
    ...
    class RequestData(dict, Enum):
        ...
        REQUEST_1 = {'recipients': 'abc@gmail.com',
                     'requestBy': faker.user_name(),
                     'requestDate': faker.date_time(),
                     'content': ContentFactory.RequestData.CONTENT_REQUEST_1}

        REQUEST_2 = {'recipients': 'abc@gmail.com',
                     'requestBy': faker.user_name(),
                     'requestDate': faker.date_time(),
                     'content': ContentFactory.RequestData.CONTENT_REQUEST_1}
    ...
    class RequestProviderData(dict, Enum):
        ...
        REQUEST_PROVIDER_1 = {'provider': Notification.NotificationProvider.GC_NOTIFY,
                              'data': {'recipients': 'abc@gmail.com',
                                       'requestBy': faker.user_name(),
                                       'requestDate': faker.date_time(),
                                       'notifyType': 'EMAIL',
                                       'content': ContentFactory.RequestProviderData.CONTENT_REQUEST_PROVIDER_1}}

        REQUEST_PROVIDER_2 = {'provider': Notification.NotificationProvider.SMTP,
                              'data': {'recipients': 'abc@gmail.com',
                                       'requestBy': faker.user_name(),
                                       'requestDate': faker.date_time(),
                                       'notifyType': 'EMAIL',
        ...
        REQUEST_PROVIDER_3 = {'provider': Notification.NotificationProvider.GC_NOTIFY,
                              'data': {'recipients': '+12508888888',
                                       'requestBy': faker.user_name(),
                                       'requestDate': faker.date_time(),
                                       'notifyType': 'TEXT',
                                       'content': ContentFactory.RequestProviderData.CONTENT_REQUEST_PROVIDER_1}}
    ...
    def create_model(session, notification_info: dict = Models.PENDING_1):
        ...
        notification = Notification(recipients=notification_info['recipients'],
