...
class NotificationFactory:  # pylint: disable=too-few-public-methods
    ...
    class RequestProviderData(dict, Enum):
        ...
        REQUEST_PROVIDER_5 = {
            ...
            "notificationRequest": json.dumps(
                {
                    "recipients": "abc@gmail.com",
        ...
        REQUEST_PROVIDER_6 = {"notificationProvider": "smtp"}

        REQUEST_PROVIDER_6_1 = {"notificationProvider": "smtp", "notificationRequest": ""}
        ...
        REQUEST_PROVIDER_8 = {
            "notificationProvider": "gc_notify",
            "notificationRequest": json.dumps(
                {
                    "recipients": "abc@gmail.com",
                    "request_by": faker.user_name(),
